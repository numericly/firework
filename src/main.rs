...
impl ColorCodes {
    pub fn chat_formatting(&self) -> &str {
        match self {
    ...
    pub fn motd_formatting(&self) -> &str {
        match self {
            ColorCodes::Obfuscated => "\\u00A7k",
            ColorCodes::Bold => "\\u00A7l",
            ColorCodes::Strikethrough => "\\u00A7m",

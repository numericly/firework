...
pub struct r#CherryPlanks;
impl Item for r#CherryPlanks {
    const ID: u32 = 28u32;
    const NAME: &'static str = "cherry_planks";
...
pub struct r#CherrySapling;
impl Item for r#CherrySapling {
    const ID: u32 = 40u32;
    const NAME: &'static str = "cherry_sapling";
...
pub struct r#SuspiciousSand;
impl Item for r#SuspiciousSand {
    const ID: u32 = 45u32;
    const NAME: &'static str = "suspicious_sand";
...
pub struct r#CherryLog;
impl Item for r#CherryLog {
    const ID: u32 = 114u32;
    const NAME: &'static str = "cherry_log";
...
pub struct r#StrippedCherryLog;
impl Item for r#StrippedCherryLog {
    const ID: u32 = 127u32;
    const NAME: &'static str = "stripped_cherry_log";
...
pub struct r#StrippedCherryWood;
impl Item for r#StrippedCherryWood {
    const ID: u32 = 137u32;
    const NAME: &'static str = "stripped_cherry_wood";
...
pub struct r#CherryWood;
impl Item for r#CherryWood {
    const ID: u32 = 148u32;
    const NAME: &'static str = "cherry_wood";
...
pub struct r#CherryLeaves;
impl Item for r#CherryLeaves {
    const ID: u32 = 158u32;
    const NAME: &'static str = "cherry_leaves";
...
pub struct r#Torchflower;
impl Item for r#Torchflower {
    const ID: u32 = 208u32;
...
pub struct r#PinkPetals;
impl Item for r#PinkPetals {
    const ID: u32 = 222u32;
    const NAME: &'static str = "pink_petals";
...
pub struct r#CherrySlab;
impl Item for r#CherrySlab {
    const ID: u32 = 233u32;
    const NAME: &'static str = "cherry_slab";
...
pub struct r#DecoratedPot;
impl Item for r#DecoratedPot {
    const ID: u32 = 264u32;
    const NAME: &'static str = "decorated_pot";
...
pub struct r#CherryFence;
impl Item for r#CherryFence {
    const ID: u32 = 292u32;
    const NAME: &'static str = "cherry_fence";
...
pub struct r#CherryStairs;
impl Item for r#CherryStairs {
    const ID: u32 = 364u32;
    const NAME: &'static str = "cherry_stairs";
...
pub struct r#CherryButton;
impl Item for r#CherryButton {
    const ID: u32 = 663u32;
    const NAME: &'static str = "cherry_button";
...
pub struct r#CherryPressurePlate;
impl Item for r#CherryPressurePlate {
    const ID: u32 = 678u32;
    const NAME: &'static str = "cherry_pressure_plate";
...
pub struct r#CherryDoor;
impl Item for r#CherryDoor {
    const ID: u32 = 690u32;
    const NAME: &'static str = "cherry_door";
...
pub struct r#CherryTrapdoor;
impl Item for r#CherryTrapdoor {
    const ID: u32 = 702u32;
    const NAME: &'static str = "cherry_trapdoor";
...
pub struct r#CherryFenceGate;
impl Item for r#CherryFenceGate {
    const ID: u32 = 713u32;
    const NAME: &'static str = "cherry_fence_gate";
...
pub struct r#CherryBoat;
impl Item for r#CherryBoat {
    const ID: u32 = 742u32;
    const NAME: &'static str = "cherry_boat";
    const DISPLAY_NAME: &'static str = "Cherry Boat";
    const STACK_SIZE: u32 = 1u32;
}
pub struct r#CherryChestBoat;
impl Item for r#CherryChestBoat {
    const ID: u32 = 743u32;
    const NAME: &'static str = "cherry_chest_boat";
    const DISPLAY_NAME: &'static str = "Cherry Boat with Chest";
    const STACK_SIZE: u32 = 1u32;
}
...
pub struct r#CherrySign;
impl Item for r#CherrySign {
    const ID: u32 = 847u32;
    const NAME: &'static str = "cherry_sign";
...
pub struct r#CherryHangingSign;
impl Item for r#CherryHangingSign {
    const ID: u32 = 858u32;
    const NAME: &'static str = "cherry_hanging_sign";
...
pub struct r#SnifferSpawnEgg;
impl Item for r#SnifferSpawnEgg {
    const ID: u32 = 1016u32;
    const NAME: &'static str = "sniffer_spawn_egg";
    const DISPLAY_NAME: &'static str = "Sniffer Spawn Egg";
}
...
pub struct r#TorchflowerSeeds;
impl Item for r#TorchflowerSeeds {
    const ID: u32 = 1102u32;
    const NAME: &'static str = "torchflower_seeds";
    const DISPLAY_NAME: &'static str = "Torchflower Seeds";
}
...
impl Item for r#Frogspawn {
    const ID: u32 = 1209u32;
    const NAME: &'static str = "frogspawn";
    const DISPLAY_NAME: &'static str = "Frogspawn";
}
pub struct r#EchoShard;
impl Item for r#EchoShard {
    const ID: u32 = 1210u32;
    const NAME: &'static str = "echo_shard";
    const DISPLAY_NAME: &'static str = "Echo Shard";
}
pub struct r#Brush;
impl Item for r#Brush {
    const ID: u32 = 1211u32;
    const NAME: &'static str = "brush";
    const DISPLAY_NAME: &'static str = "Brush";
    const STACK_SIZE: u32 = 1u32;
}
pub struct r#NetheriteUpgradeSmithingTemplate;
impl Item for r#NetheriteUpgradeSmithingTemplate {
    const ID: u32 = 1212u32;
    const NAME: &'static str = "netherite_upgrade_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#SentryArmorTrimSmithingTemplate;
impl Item for r#SentryArmorTrimSmithingTemplate {
    const ID: u32 = 1213u32;
    const NAME: &'static str = "sentry_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#DuneArmorTrimSmithingTemplate;
impl Item for r#DuneArmorTrimSmithingTemplate {
    const ID: u32 = 1214u32;
    const NAME: &'static str = "dune_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#CoastArmorTrimSmithingTemplate;
impl Item for r#CoastArmorTrimSmithingTemplate {
    const ID: u32 = 1215u32;
    const NAME: &'static str = "coast_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#WildArmorTrimSmithingTemplate;
impl Item for r#WildArmorTrimSmithingTemplate {
    const ID: u32 = 1216u32;
    const NAME: &'static str = "wild_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#WardArmorTrimSmithingTemplate;
impl Item for r#WardArmorTrimSmithingTemplate {
    const ID: u32 = 1217u32;
    const NAME: &'static str = "ward_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#EyeArmorTrimSmithingTemplate;
impl Item for r#EyeArmorTrimSmithingTemplate {
    const ID: u32 = 1218u32;
    const NAME: &'static str = "eye_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#VexArmorTrimSmithingTemplate;
impl Item for r#VexArmorTrimSmithingTemplate {
    const ID: u32 = 1219u32;
    const NAME: &'static str = "vex_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#TideArmorTrimSmithingTemplate;
impl Item for r#TideArmorTrimSmithingTemplate {
    const ID: u32 = 1220u32;
    const NAME: &'static str = "tide_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#SnoutArmorTrimSmithingTemplate;
impl Item for r#SnoutArmorTrimSmithingTemplate {
    const ID: u32 = 1221u32;
    const NAME: &'static str = "snout_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#RibArmorTrimSmithingTemplate;
impl Item for r#RibArmorTrimSmithingTemplate {
    const ID: u32 = 1222u32;
    const NAME: &'static str = "rib_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#SpireArmorTrimSmithingTemplate;
impl Item for r#SpireArmorTrimSmithingTemplate {
    const ID: u32 = 1223u32;
    const NAME: &'static str = "spire_armor_trim_smithing_template";
    const DISPLAY_NAME: &'static str = "Smithing Template";
}
pub struct r#PotteryShardArcher;
impl Item for r#PotteryShardArcher {
    const ID: u32 = 1224u32;
    const NAME: &'static str = "pottery_shard_archer";
    const DISPLAY_NAME: &'static str = "Archer Pottery Shard";
}
pub struct r#PotteryShardPrize;
impl Item for r#PotteryShardPrize {
    const ID: u32 = 1225u32;
    const NAME: &'static str = "pottery_shard_prize";
    const DISPLAY_NAME: &'static str = "Prize Pottery Shard";
}
pub struct r#PotteryShardArmsUp;
impl Item for r#PotteryShardArmsUp {
    const ID: u32 = 1226u32;
    const NAME: &'static str = "pottery_shard_arms_up";
    const DISPLAY_NAME: &'static str = "Arms Up Pottery Shard";
}
pub struct r#PotteryShardSkull;
impl Item for r#PotteryShardSkull {
    const ID: u32 = 1227u32;
    const NAME: &'static str = "pottery_shard_skull";
    const DISPLAY_NAME: &'static str = "Skull Pottery Shard";
}
pub enum Items {
    Air(r#Air),
    Stone(r#Stone),
    ...
    StrippedCherryLog(r#StrippedCherryLog),
    ...
    StrippedCherryWood(r#StrippedCherryWood),
    ...
    CherryPressurePlate(r#CherryPressurePlate),
    ...
    CherryTrapdoor(r#CherryTrapdoor),
    ...
    CherryFenceGate(r#CherryFenceGate),
    ...
    CherryBoat(r#CherryBoat),
    CherryChestBoat(r#CherryChestBoat),
    ...
    CherryHangingSign(r#CherryHangingSign),
    ...
    SnifferSpawnEgg(r#SnifferSpawnEgg),
    ...
    TorchflowerSeeds(r#TorchflowerSeeds),
    Beetroot(r#Beetroot),
    ...
    Brush(r#Brush),
    NetheriteUpgradeSmithingTemplate(r#NetheriteUpgradeSmithingTemplate),
    SentryArmorTrimSmithingTemplate(r#SentryArmorTrimSmithingTemplate),
    DuneArmorTrimSmithingTemplate(r#DuneArmorTrimSmithingTemplate),
    CoastArmorTrimSmithingTemplate(r#CoastArmorTrimSmithingTemplate),
    WildArmorTrimSmithingTemplate(r#WildArmorTrimSmithingTemplate),
    WardArmorTrimSmithingTemplate(r#WardArmorTrimSmithingTemplate),
    EyeArmorTrimSmithingTemplate(r#EyeArmorTrimSmithingTemplate),
    VexArmorTrimSmithingTemplate(r#VexArmorTrimSmithingTemplate),
    TideArmorTrimSmithingTemplate(r#TideArmorTrimSmithingTemplate),
    SnoutArmorTrimSmithingTemplate(r#SnoutArmorTrimSmithingTemplate),
    RibArmorTrimSmithingTemplate(r#RibArmorTrimSmithingTemplate),
    SpireArmorTrimSmithingTemplate(r#SpireArmorTrimSmithingTemplate),
    PotteryShardArcher(r#PotteryShardArcher),
    PotteryShardPrize(r#PotteryShardPrize),
    PotteryShardArmsUp(r#PotteryShardArmsUp),
    PotteryShardSkull(r#PotteryShardSkull),
}
impl Items {
    pub fn get_id(&self) -> u32 {
        match self {
            ...
            Self::CherryPlanks(_) => r#CherryPlanks::ID,
            ...
            Self::CherrySapling(_) => r#CherrySapling::ID,
            ...
            Self::SuspiciousSand(_) => r#SuspiciousSand::ID,
            ...
            Self::CherryLog(_) => r#CherryLog::ID,
            ...
            Self::StrippedCherryLog(_) => r#StrippedCherryLog::ID,
            ...
            Self::StrippedCherryWood(_) => r#StrippedCherryWood::ID,
            ...
            Self::CherryWood(_) => r#CherryWood::ID,
            ...
            Self::CherryLeaves(_) => r#CherryLeaves::ID,
            ...
            Self::Torchflower(_) => r#Torchflower::ID,
            ...
            Self::PinkPetals(_) => r#PinkPetals::ID,
            ...
            Self::CherrySlab(_) => r#CherrySlab::ID,
            ...
            Self::DecoratedPot(_) => r#DecoratedPot::ID,
            ...
            Self::CherryFence(_) => r#CherryFence::ID,
            ...
            Self::CherryStairs(_) => r#CherryStairs::ID,
            ...
            Self::CherryButton(_) => r#CherryButton::ID,
            ...
            Self::CherryPressurePlate(_) => r#CherryPressurePlate::ID,
            ...
            Self::CherryDoor(_) => r#CherryDoor::ID,
            ...
            Self::CherryTrapdoor(_) => r#CherryTrapdoor::ID,
            ...
            Self::CherryFenceGate(_) => r#CherryFenceGate::ID,
            ...
            Self::CherryBoat(_) => r#CherryBoat::ID,
            Self::CherryChestBoat(_) => r#CherryChestBoat::ID,
            ...
            Self::CherrySign(_) => r#CherrySign::ID,
            ...
            Self::CherryHangingSign(_) => r#CherryHangingSign::ID,
            ...
            Self::SnifferSpawnEgg(_) => r#SnifferSpawnEgg::ID,
            ...
            Self::TorchflowerSeeds(_) => r#TorchflowerSeeds::ID,
            ...
            Self::Brush(_) => r#Brush::ID,
            Self::NetheriteUpgradeSmithingTemplate(_) => r#NetheriteUpgradeSmithingTemplate::ID,
            Self::SentryArmorTrimSmithingTemplate(_) => r#SentryArmorTrimSmithingTemplate::ID,
            Self::DuneArmorTrimSmithingTemplate(_) => r#DuneArmorTrimSmithingTemplate::ID,
            Self::CoastArmorTrimSmithingTemplate(_) => r#CoastArmorTrimSmithingTemplate::ID,
            Self::WildArmorTrimSmithingTemplate(_) => r#WildArmorTrimSmithingTemplate::ID,
            Self::WardArmorTrimSmithingTemplate(_) => r#WardArmorTrimSmithingTemplate::ID,
            Self::EyeArmorTrimSmithingTemplate(_) => r#EyeArmorTrimSmithingTemplate::ID,
            Self::VexArmorTrimSmithingTemplate(_) => r#VexArmorTrimSmithingTemplate::ID,
            Self::TideArmorTrimSmithingTemplate(_) => r#TideArmorTrimSmithingTemplate::ID,
            Self::SnoutArmorTrimSmithingTemplate(_) => r#SnoutArmorTrimSmithingTemplate::ID,
            Self::RibArmorTrimSmithingTemplate(_) => r#RibArmorTrimSmithingTemplate::ID,
            Self::SpireArmorTrimSmithingTemplate(_) => r#SpireArmorTrimSmithingTemplate::ID,
            Self::PotteryShardArcher(_) => r#PotteryShardArcher::ID,
            Self::PotteryShardPrize(_) => r#PotteryShardPrize::ID,
            Self::PotteryShardArmsUp(_) => r#PotteryShardArmsUp::ID,
            Self::PotteryShardSkull(_) => r#PotteryShardSkull::ID,
        }
    }
}
